      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 print:grid-cols-4">
        <Card className="shadow-card print:shadow-none print:border">
          <CardContent className="p-4">
            <div className="flex items-center gap-2 mb-1">
              ...
              <p className="text-xs text-muted-foreground font-medium">Status de Prazo</p>
            </div>
            <Badge variant="secondary" className={andamentoReal >= andamentoPlanejado ? 'bg-success/10 text-success border-0' : 'bg-destructive/10 text-destructive border-0'}>
              {statusPrazo}
            </Badge>
          </CardContent>
        </Card>
        <Card className="shadow-card print:shadow-none print:border">
          <CardContent className="p-4">
            ...
            <p className="text-lg font-bold text-foreground">{registrosPendentes.length}</p>
        ...
        <Card className="shadow-card print:shadow-none print:border">
          <CardContent className="p-4">
            ...
            <p className="text-[10px] text-muted-foreground">{registrosAprovados.length} registro(s)</p>
          </CardContent>
        </Card>
        <Card className="shadow-card print:shadow-none print:border">
          <CardContent className="p-4">
            <div className="flex items-center gap-2 mb-1">
              ...
              <p className="text-xs text-muted-foreground font-medium">Alertas Totais</p>
            </div>
            <p className={`text-lg font-bold ${(atrasadas.length + materiaisBaixo.length + registrosPendentes.length) > 0 ? 'text-warning' : 'text-foreground'}`}>
              {atrasadas.length + materiaisBaixo.length + registrosPendentes.length}
            </p>
          </CardContent>
        </Card>
      </div>
          ...
          {diarioRegistros.slice(0, 8).map(r => (
            <div key={r.id} className="border-b border-border pb-3 last:border-0">
              ...
              {r.servicos_executados && (
                <p className="text-sm text-muted-foreground line-clamp-1">{r.servicos_executados}</p>
              )}
              {r.problemas && (
